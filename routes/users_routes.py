...
async def get_current_user(api_key: str = Depends(api_key_dependency), db: AsyncSession = Depends(get_db)):
...
async def follow_user(followed_id: int, api_key: str = Depends(api_key_dependency), db: AsyncSession = Depends(get_db)):
    user = await get_user_by_api(api_key, db)
...
async def unfollow_user(followed_id: int, api_key: str = Depends(api_key_dependency),
